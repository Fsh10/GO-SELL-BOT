...
import (
	...
	uhttp "github.com/Fsh10/GO-SELL-BOT/utils/http"
)

const (
	ReviewsLogoUrl = "https://my.GO-SELL.ru/preview/257605/logo_20220513174904.png"
	CategoryUrl    = "https://api.GO-SELL.ru/api/categories?seller_id=%s"
	ProductListUrl = "https://api.GO-SELL.ru/api/shop/products?seller_id=%s&category_id=%s&page=%d"
	ProductDataUrl = "https://api.GO-SELL.ru/api/products/%s/data"

	imageUrlTempl       = "http://graph.GO-SELL.ru/img.ashx?id_d=%s&maxlength=400"
	...
	purchasesOptionsUrl = "https://api.GO-SELL.ru/api/purchases/options"
)
